...
export function Component() {
  ...
  React.useEffect(() => {
    ...
    const animationLoop = () => {
      ...
      const s = state.current
      const projectHeight = s.projectHeight || window.innerHeight
              ...
              return (
                ...
                >
                  <Image
                    ...
                    alt={data.title}
                    fill
                    sizes="(max-width: 920px) 0px, 170px"
                    loading="lazy"
                    unoptimized
                  />
                </div>
...
export { Component as ArgentLoopInfiniteSlider }
